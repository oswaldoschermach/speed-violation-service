package com.nebulax.speed_violation_service.api.controller;

import com.nebulax.speed_violation_service.api.exception.ApiErrorResponse;
...
import com.nebulax.speed_violation_service.api.validation.ValidLicensePlate;
import com.nebulax.speed_violation_service.config.OpenApiExamples;
...
@Tag(name = "Infrações")
public interface ViolationControllerApi {
    ...
    @Operation(
            ...
            description = """
                    ...
                    **Dica:** use o exemplo *Com infração (exemplo de referência)* e depois consulte \
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    @ExampleObject(
                                            name = "Com infração (exemplo de referência)",
    ...
    EvaluateViolationResponse evaluate(
    ...
    List<StoredViolationResponse> findByLicensePlate(
            @Parameter(
